#!/usr/bin/env bash
# Run with bash on a Linux login/transfer node. No Python or GPU required.
set -euo pipefail

repo='Qwen/Qwen2.5-1.5B'
revision='8faed761d45a263340a0528343f099c05c9a4323'
destination="${1:-/pscratch/sd/s/syfan/Pier/local/qwen/models/Qwen2.5-1.5B/$revision}"
...
flock -n 9 || { echo 'Another download is using this destination.' >&2; exit 1; }

# Small files use Git blob identities; the weight file uses its LFS SHA-256.
verify() {
