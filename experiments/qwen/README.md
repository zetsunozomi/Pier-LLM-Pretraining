...
**Current next run (2026-09-21): [N3 cohort comparison](N3_HANDOFF.md),
`sbatch --export=ALL experiments/qwen/n3.sbatch`.** Four/eight-GPU
[N2 pilots](N2_HANDOFF.md) have returned. N3 measures Pier s=1/2/K together
using the same Qwen training loop, cycle timing and allocator peaks.
E0c/E0d passed reports are not required.
