...
class MyDistributedDataParallel(_BaseDataParallel):
    """
    ...
    def __init__(
        ...
        for name, param in self.module.named_parameters():
            ...
            if getattr(param, 'allreduce', True):
                ...
                print(f"Hey! expert parallel params detected, if you are not using expert model, it might be because of non-allreduce setting.")
                print(f"Our low communication training implementation do not consider expert model.")
    ...
    def broadcast_params(self):
        ...
        """
        print(f"Hey! I'm doing broadcast params, using the global communication group")
        for param in self.module.parameters():
            ...
            if is_expert_parallel:
                ...
                data_parallel_group = self.outer_group
