...
import numpy as np
# 1: DiLoCo 
times_algo1 = np.array([384.4575, 300.2625, 223.745])/1000
# 2 : DDP
times_algo2 = np.array([880.95, 773.5675, 682.8725]) /1000
# 3: MP
times_mp = np.array([903.6625, 792.21, 662.67])/1000
...
fig, ax_time = plt.subplots(figsize=(8,5.5))
...
plt.subplots_adjust(left=0.15,right=0.85,top=0.97,bottom=0.35)
plt.savefig("benchmark_medium_perlmutter_fixed.png")
