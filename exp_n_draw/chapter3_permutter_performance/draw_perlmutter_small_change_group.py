...
# --- 时间数据（秒） ---
# DiLoCo data
times_algo1_bars = np.array([np.nan, 2018.1775, 1015.0975, 518.8475, 272.0625, 151.55])
# DiLoCo data, but at gpu == 1 set to ddp
times_algo1_line = np.array([np.nan, 2018.1775, 1015.0975, 518.8475, 272.0625, 151.55])

# DDP
times_algo2 = np.array([3977.06 ,1999.03, 1021.3575, 690.215, 445.615, 299.6825])

# Momentum Produce
times_algo3 = np.array([np.nan,2017.04, 953.3975, 695.955, 448.595, 400.205])
...
plt.savefig("benchmark_small_perlmutter.png", dpi=200)
