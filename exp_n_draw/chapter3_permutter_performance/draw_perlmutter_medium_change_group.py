...
# --- 时间数据（秒） ---
# DiLoCo data
times_algo1_bars = np.array([np.nan, 4790.7475, 2313.2075, 1199.1, 637.225, 384.4575, 258.005, 216.125])
# DiLoCo data, but at gpu == 1 set to ddp
times_algo1_line = np.array([9510.7025  , 4790.7475, 2313.2075, 1199.1, 637.225, 384.4575, 258.005, 216.125])

# DDP
times_algo2 = np.array([9510.7025   ,5012.1475, 2576.98,1687.205, 1191.5225, 880.95, 773.5675, 682.8725])

# Momentum Produce
times_algo3 = np.array([np.nan,4875.8525, 2451.595 ,1763.9875 , 1209.2475, 903.6625, 792.21, 662.67])
...
plt.savefig("benchmark_medium_perlmutter.png", dpi=200)
