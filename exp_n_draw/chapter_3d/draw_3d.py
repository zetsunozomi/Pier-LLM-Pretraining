...
import numpy as np
# 1: DiLoCo 
times_algo1 = np.array([8648.96611111111, 4922.502222222222, 3059.041111111111])/1000
# 2 : DDP
times_algo2 = np.array([10615.1125, 7141.4625, 5335.0875])/1000
...
plt.subplots_adjust(left=0.07,right=0.9,top=0.97,bottom=0.35)
plt.savefig("perlmutter_7B_3d.png")
