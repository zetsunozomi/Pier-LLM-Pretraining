...
times_algo1_bars = [np.nan, 996.186, 527.817, 290.01800000000003, 185.576, 146.168]
# “scaling”折线用：DiLoCo 在 1-GPU 设为 （只用于连线与效率计算）
times_algo1_line = [1897.917, 996.186, 527.817, 290.01800000000003, 185.576, 146.168]

# DDP：新增 1-GPU=1897.917
times_algo2 = [1897.917, 1154.882, 741.394, 562.415, 478.702, 458.98]
...
plt.savefig("benchmark_4_1_with_1gpu_scaling.png", dpi=200)
