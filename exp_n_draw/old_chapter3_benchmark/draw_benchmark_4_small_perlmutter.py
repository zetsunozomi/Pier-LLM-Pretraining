...
times_algo1_bars = [np.nan, 1997.655, 1011.695, 517.602 , 273.469, 151.661]
# “scaling”折线用：DiLoCo 在 1-GPU 设为 （只用于连线与效率计算）
times_algo1_line = [3984.3360000000002, 1997.655, 1011.695, 517.602 , 273.469, 151.661]

# DDP：
times_algo2 = [3984.3360000000002, 2014.364, 952.794, 686.1443298969073,438.533, 297.801]
...
plt.savefig("benchmark_4_1_with_1gpu_scaling_perlmutter.png", dpi=200)
