...
# --- 时间数据（秒） ---
# DiLoCo data
times_algo1_bars = np.array([np.nan, 6150.0975, 3120.8475, 1600.66, 927.2325, 515.6225, 383.8325, 417.07])/1000
# DiLoCo data, but at gpu == 1 set to ddp
times_algo1_line = np.array([12185.0775, 6150.0975, 3120.8475, 1600.66, 927.2325, 515.6225, 383.8325, 417.07])/1000
