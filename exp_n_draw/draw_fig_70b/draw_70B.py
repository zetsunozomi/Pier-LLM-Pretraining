...
import numpy as np
# 1: MALT
times_algo1 = np.array([30522.1000000000, 17364.8400000000, 10468.3200000000])/1000
# 2: full DDP
times_algo2 = np.array([37687.2000000000, 27208.1666666667, 21941.6666666667])/1000
...
fig, ax_time = plt.subplots(figsize=(12.2,5.6))
...
ax_time.set_xlim(-0.3, len(gpu_labels) - 0.7)
...
plt.subplots_adjust(left=0.08,right=0.9,top=0.94,bottom=0.35)
