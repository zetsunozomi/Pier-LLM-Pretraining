...
scale = 1
fig, ax_time = plt.subplots(figsize=(12*scale,5.5*scale))
...
print(eff_1)
l3, = ax_eff.plot(group_centers, eff_1, marker='^', linestyle='--', linewidth=2, label='Pier efficiency',color = diloco_color)
...
ax_eff.set_ylim(0, 112)  # 百分比，适当留白
...
plt.subplots_adjust(left=0.1,right=0.90,top=0.97,bottom=0.34)
